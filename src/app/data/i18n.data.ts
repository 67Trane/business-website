...
export const CONTENT = {
  de: {
    ...
    hero: {
      ...
      accent: 'voranbringt.',
      sub: 'Ich entwickle moderne Websites und Web-Apps für Ihr Unternehmen und betreue sie zuverlässig weiter – von der Idee bis zum Launch, alles aus einer Hand.',
  ...
  en: {
    ...
    hero: {
      ...
      accent: 'forward.',
      sub: 'I build modern websites and web apps for your business and keep them running reliably – from idea to launch, everything from a single source.',
  ...
  tr: {
    ...
    hero: {
      ...
      sub: 'İşletmeniz için modern web siteleri ve web uygulamaları geliştiriyor, sonrasında da güvenilir şekilde destekliyorum – fikirden lansmana, hepsi tek elden.',
